...
const successfullyLogin = () => {
  return (
    <div>
      ...
      <Link to="/Register">
              <button className='w-48 mb-4 text-[18px] mt-14 rounded-full py-2 transition-colors duration-300 bg-white text-emerald-800 hover:bg-emerald-600 hover:text-white'>Go to Home</button>
            </Link>
    </div>
  )
}
